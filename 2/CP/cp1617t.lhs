...
\begin{lcbr}
|
|(invAux ~ x ) \comp \mathsf{in} = \alt{\underline{1-x}}  {mul \comp \split {invAux ~ x} {\underline{1-x}}}|

   |\\|
 
|(inv ~ x) \comp \mathsf{in} = \alt{\underline{1}\comp id} {add \comp \split {invAux ~ x} {inv ~ x} }|
|
...
\begin{lcbr} 
|
|(invAux ~ x ) \comp \mathsf{in} = \alt{\underline{1-x}, {mul \comp \split{id \comp invAux ~ x} {\underline{1-x} \comp inv ~ x}}}| 
 
  |\\|

|(inv ~ x
) \comp \mathsf{in} = \alt{\underline{1}} {add} \comp (id + \split{invAux ~ x} {inv ~ x})|
|
\end{lcbr}
\end{eqnarray*}
...
\begin{lcbr} 
|
|(invAux ~ x) \comp \mathsf{in} = \alt{\underline{1-x} \comp id} {mul \comp (id \times \underline{1-x}) \comp \split {intAux ~ x} {inv ~ x}}|
  
  |\\|

|(inv ~ x) \comp \mathsf{in} = \alt{\underline{1}} {add} \comp (id + \split{invAux ~ x} {inv ~ x}| 
|
\end{lcbr}
\end{eqnarray*}
...
\begin{lcbr} 
|
|(invAux ~ x) \comp \mathsf{in} = \alt{\underline{1-x}} {mul \comp (id \times \underline{1-x})} \comp (id + \split {intAux ~ x} {inv ~ x}|
...
\begin{lcbr}
|
|id \comp i_1 = out \comp Nil|

  |\\|

|id \comp i_2 = out \comp Block|
|
\end{lcbr}
\end{eqnarray*}
...
\xymatrix@@C=2cm{
|[A]| \ar[d]_-{\cata{g}} \ar[r]^{out} &1+(A \times [A]) \ar[d]^{F~\cata{g}}\\
|B| &1+(A \times B) \ar[l]_-{g} }

\xymatrix@@C=2cm{
|B| \ar[r]^{g} \ar[d]^{\ana{g}} &1+(A \times B) \ar[d]^{F~\cata{g}}\\
|[A]| &1+(A \times |[A]|) \ar[l]_-{in} }
...
\xymatrix@@C=2cm{
|Int| \ar[r]^{x} \ar[d]^{\ana{(x,y)}} &1+Int \times Int \ar[d]^{F~\cata{(x,y)}}\\
|Algae| &1+A \times B \ar[l]_-{in_A} }

\xymatrix@@C=2cm{
|Int| \ar[r]^{y} \ar[d]^{\ana{(x,y)}} &1+Int \ar[d]^{F~\cata{(x,y)}}\\
|B| &1+A \ar[l]_-{in_B} }

\xymatrix@@C=2cm{
|Algae| \ar[d]_-{\cata{(x,y)}} \ar[r]^{out_A} &1+(Algae \times B) \ar[d]^{F~\cata{(x,y)}}\\
|String| &1+(String \times String) \ar[l]_-{x} }

\xymatrix@@C=2cm{
|B| \ar[d]_-{\cata{(x,y)}} \ar[r]^{out_B} &1+Algae\ar[d]^{F~\cata{(x,y)}}\\
|String| &1+String \ar[l]_-{y} }
...
\begin{code}
permuta [] = return []
permuta x = do {(a,b) <- getR x; x <- permuta b; return(a:x)}
\end{code}
